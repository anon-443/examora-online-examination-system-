...
export default function ExamCatalog() {
  ...
  return <div className="min-h-screen bg-[hsl(var(--page))]"><SiteHeader /><main>
    <section className="container pb-5 pt-4 sm:pb-6 sm:pt-5"><p className="text-xs font-bold uppercase tracking-[0.16em] text-emerald-700 dark:text-emerald-400">Assessment catalogue</p><div className="mt-2 flex flex-col justify-between gap-3 md:flex-row md:items-end"><div><h1 className="font-display text-4xl font-semibold tracking-[-0.06em] text-slate-950 sm:text-5xl dark:text-white">Choose your next <span className="text-emerald-600 dark:text-emerald-400">challenge</span></h1><p className="mt-2 max-w-none text-base leading-7 text-slate-600 xl:whitespace-nowrap dark:text-slate-300">Browse published assessments by topic, time commitment, and level with progress saved to your account</p></div><Button asChild variant="outline" className="w-fit rounded-xl border-slate-200 bg-white font-semibold dark:border-white/15 dark:bg-white/5"><Link href="/leaderboard"><Trophy className="mr-1.5 size-4 text-amber-500" />Leaderboard</Link></Button></div>
