...
const subjects = [
  { name: "Mathematics", icon: Brain, accent: "from-cyan-500/20 to-transparent" },
  { name: "Science", icon: FlaskConical, accent: "from-violet-500/20 to-transparent" },
  { name: "English", icon: BookOpenCheck, accent: "from-rose-500/20 to-transparent" },
  { name: "History", icon: Landmark, accent: "from-amber-500/20 to-transparent" },
  { name: "Programming", icon: Code2, accent: "from-blue-500/20 to-transparent" },
  { name: "Business", icon: BriefcaseBusiness, accent: "from-emerald-500/20 to-transparent" },
];
