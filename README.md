...
> **Final-release status:** The application uses Manus OAuth, tRPC, Drizzle ORM, and MySQL/TiDB. It is deployed on Manus hosting, with a public GitHub repository, responsive desktop/mobile UI, **46 automated tests across 14 suites**, production builds, and a passing GitHub Actions quality gate.
